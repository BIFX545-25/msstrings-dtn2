...
#' 
#' This function takes strings from Spectronaut output, pulls meadata on protein
#' modifications, and displays the data in a nice format.
#' 
#' @param seqs Charactor vector, peptide sequence strings from Spectronaut output
#' @param format Charater value, format of the input strings
#' 
#' @return A `protein_mods` object, which is a data.frame with the amino acid sequences
#' @export 
